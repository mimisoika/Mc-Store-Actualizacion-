...
function generarMenuUsuario() {
    ...
    if ($logueado && $datosUsuario !== null) {
        ...
        $menu = '<ul class="dropdown-menu dropdown-menu-end">' .
               ...
               '<li><a class="dropdown-item" href="../../pages/perfil.php#"><i class="bi bi-person-gear me-2"></i>Mi Perfil</a></li>' .
               '<li><a class="dropdown-item" href="../../pages/perfil.php##pedidos"><i class="bi bi-bag me-2"></i>Mis Pedidos</a></li>';
        
        if ($rol === 'admin') {
            $menu .= '<li><hr class="dropdown-divider"></li>' .
                    '<li><a class="dropdown-item text-primary" href="../../pages/admin/admin_index.php"><i class="bi bi-gear-fill me-2"></i>Panel de Administrador</a></li>';
        }
        ...
        return '<ul class="dropdown-menu dropdown-menu-end">' .
               ...
               '<li><a class="dropdown-item" href="../pages/login.php#iniciar-sesion"><i class="bi bi-box-arrow-in-right me-2"></i>Iniciar Sesión</a></li>' .
               '<li><a class="dropdown-item" href="../pages/login.php#registro"><i class="bi bi-person-plus me-2"></i>Registrarse</a></li>' .
               '</ul>';
    }
}
?>