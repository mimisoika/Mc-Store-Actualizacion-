...
$(document).ready(() => {
  ...
  // Formularios
  $("#formAgregarProducto").submit((e) => {
    e.preventDefault()
    agregarProducto()
  })

  $("#formEditarProducto").submit((e) => {
    e.preventDefault()
    actualizarProducto()
  })
})
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="mt-auto">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <span class="h5 text-primary mb-0">$${Number.parseFloat(producto.precio).toFixed(2)}</span>
                                ${estadoBadge}
                            </div>
                            <div class="d-flex justify-content-between align-items-center mb-2">
...
function agregarProducto() {
  ...
  formData.append("cantidad", $("#stock").val() || 0)
...
function actualizarProducto() {
  ...
  formData.append("cantidad", $("#editStock").val() || 0)
