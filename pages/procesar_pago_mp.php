...
if ($es_exitoso) {
    // Actualizar estado del pedido a "confirmado" (esquema del usuario usa estos estados)
    // No existe columna `fecha_pago` en la definición proporcionada: se actualiza el estado y el método de pago.
