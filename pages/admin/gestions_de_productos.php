...
<body class="bg-light">
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col text-center">
                    ...
                    <p class="lead mb-0">Sistema de gestión de productos</p>
                </div>
                <div class="col-auto">
    ...
    <div class="container">
        ...
        <button class="btn btn-success mb-4" data-bs-toggle="modal" data-bs-target="#agregarProductoModal">
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" id="cantidad" min="0" step="0.01" required>
                                </div> 
                            </div>
                            <div class="col-md-4">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" id="editCantidad" min="0" step="0.01" required>
                                </div> 
                            </div>
                            <div class="col-md-4">
